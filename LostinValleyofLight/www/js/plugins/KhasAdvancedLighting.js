...
Khas.Lighting = {};
Khas.Lighting.version = 2.1;
Khas.Lighting.cache = {};
Khas.Lighting.Settings = {};
Khas.Lighting.Addons = {};
/*:
 * @plugindesc [2.1] Adds lighting to your game.
 * 
 ...
 * @default ON
 * 
 * @param Auto Battle Ambient Light
 * @desc [ON/OFF] Battles' ambient light will match the current
 * ambient light.
 * @default OFF
 *
 ...
 *  * Log
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
 *  * Version 2.1 (07.05.2017)
 * Added "Transfer Reset" parameter
 * Added "Auto Battle Ambient Light" parameter
...
Khas.Lighting.Settings.AUTO_BATTLE_AL = Khas.Lighting.PARAMETERS["Auto Battle Ambient Light"].toLowerCase() == "on";
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
// * PixiOutOfDate Error
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
  ...
  Graphics._createRenderer = function() {
    ...
    if (typeof PIXI.BLEND_MODES != 'undefined') {
      ...
      // TODO remove this
      // Make ambient light to have a color
      // DST_COLOR -> lights are very bright
      //this._renderer.state.blendModes[PIXI.BLEND_MODES.KHAS_LIGHTING] = [gl.DST_COLOR, gl.SRC_COLOR]
    } else {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  ...
  Game_Map.prototype.khasSetupMap = function() {
    ...
    if (Khas.Lighting.Settings.TRANSFER_RESET) {
      ...
      if (Khas.Lighting.Settings.AUTO_BATTLE_AL) this._battleLighting.setAmbientLight("ffffffff");
    };
    ...
    case "ambient_light": 
      ...
      if (switchId > 0) {
        if ($gameSwitches.value(switchId)) {
          ...
          if (Khas.Lighting.Settings.AUTO_BATTLE_AL) this._battleLighting.setAmbientLight(target);
        };
      } else {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
  ...
  Game_CharacterBase.prototype.setLight = function(lightId) {
    this.clearLight();
    if (lightId) {
      if (Khas.Lighting.LIGHTS[lightId]) {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
  ...
  Game_Event.prototype.callKhasCommand = function(command, value1, value2) {
    ...
    case "light_size": 
      ...
      console.log("size " + (this._light_size) + "");
      break;
    default: 
      this.kal_callKhasCommand(command, value1, value2);
    };
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
  ...
  Game_Interpreter.prototype.pluginCommand = function(command, args) {
    ...
    case "ambientlight": 
      ...
      if (Khas.Lighting.Settings.AUTO_BATTLE_AL) $gameMap.battleLighting.setAmbientLight(target);
      break;
...
Sprite_Light.prototype.constructor = Sprite_Light;
  ...
  Sprite_Light.prototype.initialize = function(character) {
    ...
    this._screenX = 0;
    this._screenY = 0;
    //Khas.Lighting.cache[this._id] = ImageManager.loadLight(this.getData().fileName) unless Khas.Lighting.cache[this._id]
